...
module riscv_multicycle import riscv_pkg::*; #(
    ...
    register_file u_regfile (
        ...
        .we_i(wb_reg_we && wb_valid), // Writeback stage feedback
    ...
    // Real flush logic would check branch condition here 
    ...
    assign mem_wrt_o  = 1'b0; // Memory write happens in MEM stage

    // --- 13. HAZARD UNIT LOGIC (Simplified) --- 
    assign stall = (ex_valid && ex_mem_we && (ex_rd_addr == rs1_addr || ex_rd_addr == rs2_addr));
    assign flush = 1'b0; // To be implemented for branch instructions
